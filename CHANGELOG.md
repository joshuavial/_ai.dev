...
- Reordered boot protocol steps to confirm workflow phase and load workflow instructions before task selection, clarifying when to gather state references and update continuity artefacts.
